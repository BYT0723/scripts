...
if [[ "$local_remote_port" == "$remote_local_port" ]] || [[ "$(http_proxy= https_proxy= all_proxy= curl -s -m 5 -o /dev/null -w "%{http_code}" -L https://byt0723.xyz:$remote_local_port)" != "200" ]]; then
