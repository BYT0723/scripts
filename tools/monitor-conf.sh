...
SINGLE_MONITOR_MAP["DisplayPort-0"]="--primary --mode 2560x1440 --rate 144.00 --rotate normal"
...
MONITOR_MAP["DisplayPort-0"]="--mode 2560x1440 --rate 144.00 --set "TearFree" on --rotate normal --left-of eDP"
